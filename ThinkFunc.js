...
//Take an array of strings and return the longest string
export function findLongest(arrStrings){
    let retString="";
...
export function stringsLongerThan(arrStrings, num){
...
export function recurseBetween(start, n){
    console.log(start);
    if(start == n){
